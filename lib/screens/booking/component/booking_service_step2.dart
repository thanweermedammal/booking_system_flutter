          ...
          Container(
            ...
            child: Column(
              children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(language!.lblSubTotal, style: primaryTextStyle()).flexible(fit: FlexFit.loose),
                          16.width,
                          Text(
                ...
                if (widget.data.service_detail!.discount.validate() != 0)
                  Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text(language!.lblDiscount, style: primaryTextStyle()),
                          Text(
                ...
                Row(
                  children: [
                    if (widget.data.service_detail!.appliedCouponData != null) Text(language!.lblCoupon, style: boldTextStyle()) else Text(language!.lblCoupon, style: primaryTextStyle()).expand(),
