...
class _UserChatScreenState extends State<UserChatScreen> {
  ...
  Future<void> sendMessages() async {
    ...
    await chatMessageService.addMessage(data).then((value) async {
      ...
      /// Send Notification
      notificationService.sendPushNotifications(getStringAsync(DISPLAY_NAME), messageCont.text, receiverPlayerId: widget.receiverUser.player_id).catchError((e) {
    ...
    return Scaffold(
      appBar: appBarWidget(
        ...
        titleWidget: Hero(
          ...
          child: Text(widget.receiverUser.display_name.validate(), style: TextStyle(color: whiteColor)),
        ),
      ),
      body: SizedBox(
