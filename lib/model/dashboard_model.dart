...
class DashboardCustomerReview {
  ...
  DashboardCustomerReview({this.attchments, this.booking_id, this.created_at, this.customer_id, this.customer_name, this.id, this.profile_image, this.rating, this.review, this.service_id, this.service_name});
